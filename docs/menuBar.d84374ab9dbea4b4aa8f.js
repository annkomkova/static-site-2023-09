...
function A_MainMenu_typeof(o) { "@babel/helpers - typeof"; return A_MainMenu_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, A_MainMenu_typeof(o); }
function A_MainMenu_defineProperty(obj, key, value) { key = A_MainMenu_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function A_MainMenu_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, A_MainMenu_toPropertyKey(descriptor.key), descriptor); } }
...
function A_MainMenu_toPropertyKey(arg) { var key = A_MainMenu_toPrimitive(arg, "string"); return A_MainMenu_typeof(key) === "symbol" ? key : String(key); }
function A_MainMenu_toPrimitive(input, hint) { if (A_MainMenu_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (A_MainMenu_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
